...
func newOrganizationsTableImpl(schemaName, tableName, alias string) organizationsTable {
	var (
		...
		allColumns      = postgres.ColumnList{IDColumn, NameColumn, UpdatedAtColumn, CreatedAtColumn}
		mutableColumns  = postgres.ColumnList{NameColumn, UpdatedAtColumn, CreatedAtColumn}
		defaultColumns  = postgres.ColumnList{}
	)
